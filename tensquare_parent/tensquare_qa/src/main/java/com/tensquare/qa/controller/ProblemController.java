...
public class ProblemController {
	...
	public Result<PageResult<Problem>> newList(@PathVariable String label,
										 @PathVariable Integer page,
										 @PathVariable Integer size){
		Page<Problem> pageData = problemService.newList(label,page,size);
		PageResult<Problem> problemPage = new PageResult<>(pageData.getTotalElements(),pageData.getContent());
		return new Result<>(true,StatusCode.OK,"查询成功",problemPage);
	}

	///problem/hotlist/{label}/{page}/{size}
    @GetMapping("/hotlist/{label}/{page}/{size}")
    public Result<PageResult<Problem>> hotList(@PathVariable String label,
                                               @PathVariable Integer page,
                                               @PathVariable Integer size){
    ...
    public Result<PageResult<Problem>> waitList(@PathVariable String label,
                                                @PathVariable Integer page,
                                                @PathVariable Integer size){
